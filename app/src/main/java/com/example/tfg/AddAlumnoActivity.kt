...
import com.example.tfg.GestionarAlumnoActivity.Companion.profesorEnviado
...
class AddAlumnoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        AlumRecyclerView = findViewById(R.id.rvAlumADAdd)
        AlumRecyclerView.layoutManager = LinearLayoutManager(this)
        AlumRecyclerView.setHasFixedSize(true)
        tvLoadingDataAlum = findViewById(R.id.tvLoadingDataAlumAdd)
        AlumList = arrayListOf<Model>()
        AlumElegido = findViewById(R.id.AlumElegidoAdd)
        getProfData()
