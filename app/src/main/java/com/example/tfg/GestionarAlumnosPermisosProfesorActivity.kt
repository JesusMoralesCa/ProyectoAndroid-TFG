...
import com.example.tfg.HomeActivity.Companion.ProfesorGA

class GestionarAlumnosPermisosProfesorActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_gestionar_alumnos_permisos_profesor)

        AlumRecyclerView = findViewById(R.id.rvAlumADpp)
        AlumRecyclerView.layoutManager = LinearLayoutManager(this)
        AlumRecyclerView.setHasFixedSize(true)
        tvLoadingDataAlum = findViewById(R.id.tvLoadingDataAlumpp)
        AlumList = arrayListOf<Model>()
        AlumElegido = findViewById(R.id.AlumElegidopp)
        getProfData()
    ...
    private fun getProfData() {
        ...
        FirebaseFirestore.getInstance().collection("/Sensei/JesusMorales/Profesores/$ProfesorGA/Alumnos").get()
    ...
    private fun EliminarAlum() {
        ...
        val rutaDocumentoOrigen = "/Sensei/JesusMorales/Profesores/$ProfesorGA/Alumnos/$selectecAlum"
...
////////////
    ...
    private fun AñadirAlumno(profesor: String){
        ...
        val intent = Intent(this, AddAlumnosPermisosProfActivity::class.java)
